 ...
 * @author Cecy
 */
public class EjercicioPractico extends javax.swing.JFrame {

    /**
     * Creates new form EjercicioPractico
     */
    public EjercicioPractico() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EjercicioPractico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        //</editor-fold>
        String password="Josaphat";
        String passwordEncrypter=DigestUtils.md5Hex(password);
        System.out.println(passwordEncrypter);
        /* Create and display the form */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EjercicioPractico().setVisible(true);
            }
        });
    }
